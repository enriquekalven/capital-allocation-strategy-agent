...
from capital_allocation_strategy_agent.callbacks import (
    before_tool_callback_check_process_status,
    extract_request_id_from_request,
    llm_judge_gate,
)
from capital_allocation_strategy_agent.prompt import ORCHESTRATOR_PROMPT
from capital_allocation_strategy_agent.sub_agents.document_extraction import (
    document_extraction_agent,
)
from capital_allocation_strategy_agent.sub_agents.loan_decision import loan_decision_agent
from capital_allocation_strategy_agent.sub_agents.pricing import pricing_agent
from capital_allocation_strategy_agent.sub_agents.underwriting import underwriting_agent
...
root_agent = LlmAgent(
    name="CapitalAllocationStrategyOrchestratorAgent",
    model=MODEL_NAME,
...
app = App(
    name="capital_allocation_strategy_agent",
