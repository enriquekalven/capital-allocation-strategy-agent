...
from capital_allocation_strategy_agent.callbacks.after_agent_callback.models import JudgeVerdict
from capital_allocation_strategy_agent.callbacks.after_agent_callback.prompt import JUDGE_PROMPT
...
AGENT_OUTPUT_KEYS = [
    "MarketIntelligenceAgent_output",
    "PortfolioRiskAgent_output",
    "CapitalStructureAgent_output",
    "GovernanceAuditorAgent_output",
]
