...
class ProcessStateService:
    ...
    STEP_MARKET_INTELLIGENCE = "MarketIntelligenceAgent"
    STEP_PORTFOLIO_RISK = "PortfolioRiskAgent"
    STEP_CAPITAL_STRUCTURE = "CapitalStructureAgent"
    STEP_GOVERNANCE_AUDITOR = "GovernanceAuditorAgent"

    ALL_STEPS = [
        STEP_MARKET_INTELLIGENCE,
        STEP_PORTFOLIO_RISK,
        STEP_CAPITAL_STRUCTURE,
        STEP_GOVERNANCE_AUDITOR,
    ]
    ...
    def create_process(self, request_id: str, session_id: str) -> dict[str, Any]:
        ...
        process_state = {
            ...
            "current_step": self.STEP_MARKET_INTELLIGENCE,
