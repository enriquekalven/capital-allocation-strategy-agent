...
from capital_allocation_strategy_agent.sub_agents.document_extraction.tools import (
...
document_extraction_agent = LlmAgent(
    ...
    description="Analyzes external market comps and segment leakage (e.g. losing MoM to Square/Stripe)",
