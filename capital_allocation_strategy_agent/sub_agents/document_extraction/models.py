...
class MarketIntelligenceData(BaseModel):
    ...
    segment_name: str = Field(
        default="",
        description="Name of the strategic segment (e.g., 'Artisan')",
    )
    market_leakage_rate: str = Field(
        default="",
        description="Percentage of leakage stated in prompt or context (e.g., '4% MoM')",
    )
