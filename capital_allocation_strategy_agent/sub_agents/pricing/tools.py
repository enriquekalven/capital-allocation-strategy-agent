...
def calculate_loan_pricing(tool_context: ToolContext) -> dict:
    ...
    try:
        ...
        if not application_data:
            ...
            logger.warning("No application_data found, using mock C-Suite defaults")
        ...
        return {
            ...
            "risk_tier": risk_tier,
            "projected_irr": "14.2% (Target: 12.0%)",
            "capital_ratio_impact": "-15 bps (Maintain > 13% Tier 1)",
            "competitor_moat": "Premium relationship banking + tier 1 sweep yields (4.5%).",
            "rate_justification": (
